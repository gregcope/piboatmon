...
# http://www.catb.org/gpsd/gpsd-time-service-howto.html
  ...
  exec { 'configNtpGpsFudge':
    logoutput => true,
    command => '/usr/bin/perl -p -i -e "s#fudge 127\.127\.28\.0.*#fudge 127\.127\.28\.0 time1 \+0\.510 refid GPS#" /etc/ntp.conf',
    unless => '/bin/grep "fudge 127.127.28.0 time1 +0.510 refid GPS" /etc/ntp.conf',
    notify => Service [ 'ntp' ],
